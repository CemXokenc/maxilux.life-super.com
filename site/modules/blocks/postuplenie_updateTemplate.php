<form action="" method="post" id="postuplenie_update" enctype="multipart/form-data">
  ...
  <table class="table table-bordered">
    ...
    <tr>
      <td style="width:50px;"><?php echo $site_variables["postuplenie"]["nomer"]; ?> </td>
      <td style="width:250px;"><select name="postavshik" class="form-control">
          ...
          <option <?php if( $site_variables["postavshik"]["id"] == $site_variables["postuplenie"]["postavshik_id"] ){ ?>selected<?php } ?> value="<?php echo $site_variables["postavshik"]["id"]; ?>"><?php echo $site_variables["postavshik"]["name"]; ?></option>
          <?php } ?>
        </select>
      </td>
      <td><input type="text" class="form-control" name="nomer_naklodnoy" <?php if( $site_variables["postuplenie"]["nomer_naklodnoy"] != "" ){ ?>value="<?php echo $site_variables["postuplenie"]["nomer_naklodnoy"]; ?>"<?php } ?>style="width:150px;"></td>
      <td>
        <div id="dp-ex-4" class="input-group date" data-auto-close="true" data-date="<?php if( $site_variables["postuplenie"]["data_postupleniya"] > 0 ){ ?><?php echo $site_variables["postuplenie"]["data_postupleniya"]; ?><?php }else{ ?>01-02-2014<?php } ?>" data-date-format="dd-mm-yyyy" data-date-autoclose="true">
          <input  name="data_postupleniya" value="<?php if( $site_variables["postuplenie"]["data_postupleniya"] > 0 ){ ?><?php echo $site_variables["postuplenie"]["data_postupleniya"]; ?><?php }else{ ?><?php echo $site_variables["data_postupleniya"]; ?><?php } ?>" class="form-control" type="text">
          <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
        </div>
      </td>
      <td style="width:150px;"><input class="form-control" type="text" name="summa" <?php if( $site_variables["postuplenie"]["summa"] > 0 ){ ?>value="<?php echo $site_variables["postuplenie"]["summa"]; ?>"<?php } ?>></td>
      <td style="width:150px;">
        <select id="valuta" name="valuta"  class="form-control">

          <?php foreach($site_variables["valuty"] as $site_variables["valuta"]){ ?>
          <option <?php if( $site_variables["valuta"]["kod_valuty"]== $site_variables["postuplenie"]["valuta"]){ ?>selected<?php } ?> value="<?php echo $site_variables["valuta"]["kod_valuty"]; ?>"><?php echo $site_variables["valuta"]["name"]; ?></option>
          <?php } ?>
        </select>
      </td>
    </tr>
  ...
  <div class="" style="width: 700px;">
    ...
    <div class="row">
      ...
      <div class="col-sm-2" style="width: 340px;">
        ...
        Изменить цену на складе<span id="price_na_sklade"></span> <input type="checkbox" id="change_price">
      </div>
    </div>
...
<span id="table_documents">
    <?php echo $site_variables["table_documents"]; ?>
</span>
<div class="row">
...
<script type="text/javascript">
    $('#add_document').click(function(){
        ...
        $.ajax({
            ...
            type: "POST",
            url: "",
            data:{"do":"documents_refresh","document_url":document_url},
...
$('#add_tovar').click(function(){
  ...
  $.ajax({
    ...
    type: "POST",
    url: "",
    data:{"type":"refresh","sklad":sklad,"product":product,"cnt":cnt,"price":price,"change_price":change_price},
    success: function(html){
