...
function generate_review_and_price($session_data, $main_tovar_id, $prod_name, $order_id){
  ...
  */
    ...
    if(count($session_data[$main_tovar_id]['category'])>0){
        ...
        foreach($products_list as $category_id=>$products){
            ...
            $details .= "<tr><td class='th'></td><td class='th'><strong>".$category_info[0]['name']."</strong></td><td class='th'></td><td></td class='th'><td class='th'></td></tr>";
                ...
                if(isset($session_data[$main_tovar_id]['product'][$products[$z]])){
                    ...
                    if($product_id > 0){
                        ...
                        if($gl_session["session_data"]['zak_price']==1){
                            $zak_price = (round($price,2))."<br>";
                            $zak_total = (round($price*$category_data[0]["kolichestvo"],2))."<br>";
                        }
                        ...
                        $details .=
                            "<tr>
               <td class='th'>".($num++)."</td>
 <td class='th'>".$category_list.$info[0]['name']."</td>
 <td class='th'>".$category_data[0]["kolichestvo"]."</td>
 <td class='th'>".$zak_price.(round($rozn_cena,2))."</td>
 <td class='th'>".$zak_total.(round($rozn_cena_2,2))."</td>
</tr>";
        ...
        if($products_all[0]['izdelie_type'] != 0){
            $details .=
                "<tr>
         <td class='th' colspan='5' style='text-align:center;'>Изделия</td>
    </tr>";
         ...
         <td class='th'>".$zak_price."Розн.".(round($summa_rozniza,2))."</td>         
</tr>";
        }
    ...
    $html_page = "<form id='form_main'><table class='table table-bordered' style='width:750px;'>
    <tr><th class='th' colspan='5'>Приложение №1 к договору №$order_id</th></tr>
	<tr>
		<td class='th'>№</td>
		<td class='th' colspan='2'>Торговая Точка</td>
		<td class='th'>Пользователь</td>
		<td class='th'>Дата</td>
	</tr>
	<tr>
		<td class='th'>$order_id</td>
		<td class='th' colspan='2'>".$outlet_name[0]['name']."</td>
		<td class='th'>".$manager[0]['first_name']." ".$manager[0]['last_name']."</td>
		<td class='th'>".$order_date[0]['order_date']."</td>
	</tr>
 <tr>
 ...
 <tr>
  <td colspan='5'><strong>Данные о изделии:</strong><br><br>".$izdeliya_info."</td>  
 </tr>
 <tr>
	<td class='th'>№</td>
	<td class='th'>Наименование</td>
 ...
 ".$details."
  <tr>
  <td class='th' colspan='5'><strong>Итого к оплате: ".(round($rozn_cena,2))." ".$gl_session["session_data"]['valyta']."</strong></td>
 </tr><tr><td class='th' colspan='2'>Подпись заказчика</td><td colspan='3'></td></tr><tr><td class='th' colspan='2'>Подпись исполнителя</td><td colspan='3'></td></tr>
</table></form><input type='button' id='pdf' value='PDF'><input type='button' id='csv' value='CSV'>";
